...
const PostsPage = ({ data }) => {
  ...
  return (
    <div className="min-h-screen lg:mx-80 mx-2 ">
      <Head>
        <title>Posts | Ubaidurrahman</title>
        <meta
          name="viewport"
          content="initial-scale=1.0, width=device-width user-scalable=no "
        />
        <title>Posts - Ubaidurrahman</title>
        <meta property="og:title" content="Posts - Ubaidurrahman" />
        <meta property="og:site_name" content="Ubaidurrahman" />
        <meta property="og:url" content="https://ubaidurrahman.com/posts" />
        <meta property="og:description" content="Posts by Ubaidurrahman." />
        ...
        <meta name="twitter:title" content="Posts - Ubaidurrahman" />
